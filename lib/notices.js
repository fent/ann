    ...
    registeredCheck: {
      error: {
        ...
        registered: {
          ...
          match: ['Please log in before attempting to verify your registration.', 'This nickname is registered. Please choose a different nickname, or identify via /msg NickServ identify <password>.']
        }
      }
    },
    identify: {
