module.exports =
  # list of replies from server during connection attempt
  connect:
    error:
  ...
  register:
    ...
    success: [
      new RegExp('^Nickname .+ registered under your account')
      new RegExp('^.+ is now registered to .+, with the password .+\.$')
    ]
